...
public class MongodbUtils {
	 ...
	 *            集合名
	 */
	public static void insertOrUpdate(String accordingKey, Object accordingValue, String[] updateKeys, Object[] updateValues,
								   String collectionName) {
		...
		mongodbUtils.mongoTemplate.upsert(query, update, collectionName);
	}
	 ...
	 * @param obj 对象
	 * @param findKeys 查询条件
	 * @param findValues 查询参数
	 * @param pageStart 开始位置
	 * @param pageSize 个数
	 * @param collectionName 表名称
	 * @return
	 */
	public static List<? extends Object> page(Object obj, String[] findKeys, Object[] findValues, int pageStart, int pageSize, String collectionName) {
	 ...
	 * @return
	 */
	public static List<? extends Object> page(Object obj, String[] findKeys, Object[] findValues, int pageStart, int pageSize) {
	 ...
	 * 全文检索
	 * @param obj 对象
	 * @param searchKeys 检索内容
	 * @param pageStart 开始位置
	 * @param pageSize 每页数量
	 * @return
	 */
	public static List<? extends Object> search(Object obj, String[] searchKeys, int pageStart, int pageSize) {

		Query query = new Query();

		TextCriteria criteria = TextCriteria.forDefaultLanguage().matchingAny(searchKeys);
		query.addCriteria(criteria);
		List<Sort.Order> orders = new ArrayList();
		orders.add(new Sort.Order(Direction.DESC, "createTime"));
		Sort sort = Sort.by(orders);
