...
<head>
    ...
    <![endif]-->
    <style>
        body {background-image:url("/admin/images/bg.jpg");height:100%;width:100%;}
    ...
    <div class="admin-login-background">
        ...
        <form id="form1" class="layui-form" action="">
            <div>
                ...
                <input type="text" name="loginName" placeholder="请输入用户名" autocomplete="off" class="admin-input admin-input-username" value="admin">
            </div>
            <div>
                <i class="layui-icon layui-icon-password admin-icon"></i>
                <input type="password" name="passWord" placeholder="请输入密码" autocomplete="off" class="admin-input" value="123456">
            </div>
<#--            <div>-->
